...
if (file_exists('/var/www/site-php/eebjiencke/d7-settings.inc')) {
  require '/var/www/site-php/eebjiencke/d7-settings.inc';
}
else {
  $databases['default']['default'] = [
    'database' => 'acquia',
    'username' => 'root',
    'password' => '',
    'host' => ($_ENV['AH_SITE_GROUP'] == 'ama') ? 'host.docker.internal' : 'database',
    'port' => ($_ENV['AH_SITE_GROUP'] == 'ama') ? 33077 : 3306,
    'driver' => 'mysql',
    'prefix' => '',
    'collation' => 'utf8_general_ci',
  ];
